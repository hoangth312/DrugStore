...
class  SearchDrugsAdapter(private val listDrug: ArrayList<SearchDrugsModel>, private val cellClickListener: CellClickListener): RecyclerView.Adapter<SearchDrugsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       ...
       holder.itemView.imageDrugs.setImageResource(listDrug[position].image)
        ...
        holder.itemView.setOnClickListener {
            cellClickListener.onCellClickListener(drugsModel)
        }
    ...
    interface CellClickListener {
        fun onCellClickListener(drugModel: SearchDrugsModel)
    }
